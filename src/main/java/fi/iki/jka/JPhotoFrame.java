 ...
 *
 * @version $Id: JPhotoFrame.java,v 1.14 2011/09/05 07:38:03 jkarjala Exp $
 */
package fi.iki.jka;
...
public class JPhotoFrame extends JFrame
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (cmd.equals(JPhotoMenu.A_NEW) || cmd.equals(JPhotoMenu.A_OPEN)) {
            ...
            JOptionPane.showMessageDialog(this, APP_NAME+" v1.5.0 - Organize and Publish Your Digital Photos.\n"+
    ...
    public void setFrameIcon() {
        ...
        if (icon==null) {
            ...
            if (res!=null) { // for some reason this can be null under Eclipse...
    ...
    public void showExif() {
        ...
        ExifSubIFDDirectory directory = photo.getExifDirectory();
